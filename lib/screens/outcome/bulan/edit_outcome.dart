...
class _EditOutcomeState extends State<EditOutcome> {
  ...
  void editOutcome() {
    ...
    if (desc.isNotEmpty && value.isNotEmpty) {
      final outcome = OutcomeBulan(desc, int.parse(value), _selectedDate);

      OutcomeBulanViewModel.update(outcome, widget.index);
