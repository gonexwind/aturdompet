...
class _EditIncomeState extends State<EditIncome> {
  ...
  void editIncome() {
    ...
    if (desc.isNotEmpty && value.isNotEmpty) {
      final income = IncomeMinggu(desc, int.parse(value), _selectedDate);

      IncomeMingguViewModel.update(income, widget.index);
